        ...
        return (
            <div className={styles.studyFilterResult}>
                 <div className={styles.selectedInfo} data-test="selected-info">
                    ...
                    <strong data-test="selected-patients">{this.props.store.selectedPatients.length.toLocaleString()} patients&nbsp;|&nbsp;</strong>
                    <strong data-test="selected-samples">{this.props.store.selectedSamples.result.length.toLocaleString()} samples</strong>
                </div>
