...
export class ResultsViewPageStore {
    ...
    @computed get customDataFilterAppliers() {
        return {
            ...
            [MutationTableColumnType.CHROMOSOME]: createNumericalFilter(
                (d: Mutation) => {
            ...
            [MutationTableColumnType.STUDY]: createCategoricalFilter(
                (d: Mutation) =>
            ...
            [MutationTableColumnType.CANCER_TYPE_DETAILED]: createCategoricalFilter(
                (d: Mutation) =>
