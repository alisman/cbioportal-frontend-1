...
export declare function filterCBioPortalWebServiceData<T>(oql_query:string, data:T[], default_oql:string, by_oql_line, mark_oql_regulation_direction:boolean): T[];