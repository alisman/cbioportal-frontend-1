            ...
            'selected': {
                ...
                formatter: ({name, rowData: geneset}:IColumnFormatterData<Geneset>) => (
                    ...
                    {!!(geneset) && (
                            ...
                            {() => (
                                <LabeledCheckbox
                                checked={!!this.store.map_genesets_selected_volcano.get(geneset.name)}
                                onChange={event => (this.store.map_genesets_selected_volcano.set(geneset.name, event.target.checked)) }
                            />
                            )}
                    </Observer>
                    </div>
